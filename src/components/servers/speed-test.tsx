        ...
        >
          <div className="mb-6">
            <motion.div
              ...
              className={`inline-flex items-center justify-center w-20 h-20 rounded-2xl mb-4 ${isLoading
          ...
          <motion.button
            ...
            disabled={isLoading}
            className={`px-8 py-4 text-lg font-semibold text-white rounded-xl shadow-lg transition-all duration-300 ${isLoading
